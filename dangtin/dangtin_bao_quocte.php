...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['add_news_bao_quocte'])) {
        $title = $_POST['title'];
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO news_bao_quocte (title, content, link, image, post_date) 
                    VALUES (?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
    ...
    } elseif (isset($_POST['delete_news_bao_quocte'])) {
        $news_id = intval($_POST['news_id']);
        $delete_sql = "DELETE FROM news_bao_quocte WHERE id = ?";
...
$sql = "SELECT * FROM news_bao_quocte ORDER BY id DESC";
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="dangtin-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="dangtin_bao_quocte.php" class="active">
                            <i class="bi bi-circle"></i><span>Đăng tin báo quốc tế</span>
                        </a>
                    </li>                    
                    <li>
                        <a href="dangtin_bao_trongnuoc.php">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="dangtin_bao_quocte.php" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <button type="submit" name="add_news_bao_quocte" class="btn btn-primary">Thêm tin tức</button>
                            </form>
                        </div>
                    </div><!-- End Form Card -->
                                ...
                                <tbody>
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo '<td>
                                                <form method="post" action="dangtin_bao_quocte.php" style="display:inline;" onsubmit="return confirmDelete();">
                                                    <input type="hidden" name="news_id" value="' . $row["id"] . '">
                                                    <button type="submit" name="delete_news_bao_quocte" class="btn btn-danger btn-sm">Xóa</button>
                                                </form>
                                            </td>';
