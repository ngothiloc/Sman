...
$sql = "SELECT COUNT(*) FROM news_bao_quocte";
...
$sql = "SELECT * FROM news_bao_quocte ORDER BY id DESC LIMIT ?, ?";
$stmt = $conn->prepare($sql);
...
$sql_featured = "SELECT * FROM news_bao_quocte ORDER BY id DESC LIMIT 1";
$result_featured = $conn->query($sql_featured);
$featured_news_bao_quocte = $result_featured->fetch_assoc();
$conn->close();
?>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="ketqua-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="baibao-quocte.php" class="active">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Báo quốc tế</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            <div class="row align-items-top">
                <div class="col-lg-8">
                    ...
                    <!-- Tin noi bat -->
                    <div class="card mb-3">
                        <div class="card-header">Bài báo quốc tế nổi bật</div>
                        <div class="row g-0">
                            <?php if ($featured_news_bao_quocte): ?>
                                <div class="col-md-4">
                                    <img src="uploads/<?php echo htmlspecialchars($featured_news_bao_quocte['image']); ?>" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo htmlspecialchars($featured_news_bao_quocte['title']); ?></h5>
                                        <p class="card-text"><?php echo htmlspecialchars($featured_news_bao_quocte['content']); ?></p>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <i class="fa-solid fa-clock"></i> <?php echo date("d - m - Y", strtotime($featured_news_bao_quocte['post_date'])); ?>
                                </div>
                            <?php else: ?>
