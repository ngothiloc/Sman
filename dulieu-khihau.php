...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="csdl-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="dulieu-khihau.php" class="active">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Dữ liệu vi khí hậu và thời tiết vùng nuôi</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Cơ sở dữ liệu</li>
                    <li class="breadcrumb-item">Dữ liệu vi khí hậu, thời tiết vùng nuôi</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Bảng báo cáo về dữ liệu vi khí hậu và thời thiết vùng nuôi</h5>
                            ...
                            <table class="table datatable table-striped">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th data-type="date" data-format="YYYY/DD/MM">Thời gian</th>
                                        <th>Độ Ẩm</th>
                                        <th>Nhiệt độ</th>
                                        <th>Tốc Độ Gió</th>
                                        <th>Hướng Gió</th>
